...
std::ostream& operator<<(std::ostream& os, const math::EulerRotation<Scalar, Dim>& rotation)
{
    std::cout << "[ ";
    if constexpr (Dim == 3) {
...
template <typename Scalar, int Dim>
std::ostream& operator<<(std::ostream& os, const math::EulerTransform<Scalar, Dim>& transform)
{
